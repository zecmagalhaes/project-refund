// Seleciona os elementos de comentário.
...
form.onsubmit = (event) => {
  ...
  // Define a formatação do retorno de horário.
  const options = {
  ...
  //Cria o objeto com os detalhes na nova despesa.
  const newExpense = {
    id: new Date().getTime(),
    ...
    created_at:
      ...
      " - " +
      new Date().toLocaleTimeString("pt-BR", options),
  }
...
function updateTotals() {
  try {
    ...
    //Atualiza a qunatidade de itens da lista.
    ...
    for (let item = 0; item < items.length; item++) {
      ...
      //Remove os caracteres e substitui a vírgula pelo ponto.
